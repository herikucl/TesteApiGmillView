...
{
    public class GetProjectHandler : IRequestHandler<GetProjectRequest, GenericResponse>
    {
        private readonly CompanyContext _context;
        private readonly IMapper _mapper;
        public GetProjectHandler(CompanyContext context, IMapper mapper)
        {
            _context = context;
            _mapper = mapper;
        }

        public async Task<GenericResponse> Handle(GetProjectRequest request, CancellationToken cancellationToken)
        {
            if (request == null)
            ...
            return GenericResponse.Ok<Project>(project);
        }
    }
}
